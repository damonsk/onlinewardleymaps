...
class ViewportManager {
    ...
    getOptimalViewport(components: UnifiedComponent[], anchors: UnifiedComponent[], canvasDimensions: MapCanvasDimensions): OptimalViewport;
...
const useOptimalViewport = (components: UnifiedComponent[], anchors: UnifiedComponent[], canvasDimensions: MapCanvasDimensions) =>
    OptimalViewport;
