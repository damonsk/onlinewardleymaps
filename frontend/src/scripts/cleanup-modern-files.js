...
const componentsByDir = {
    map: [
        ...
        ['UnifiedMapContent', 'UnifiedMapContent'],
        ...
        ['EvolvingComponentLink', 'EvolvingComponentLink'],
        ['FluidLink', 'FluidLink'],
        ['FlowText', 'FlowText'],
        ['Inertia', 'Inertia'],
        ...
        ['Note', 'Note'],
        ['Pipeline', 'Pipeline'],
        ['PipelineVersion2', 'PipelineVersion2'],
        ['RelativeMovable', 'RelativeMovable'],
        ['MapPipelines', 'MapPipelines'],
    ],
    symbols: [
        ['ComponentSymbol', 'ComponentSymbol'],
        ['AcceleratorSymbol', 'AcceleratorSymbol'],
        ['AnchorSymbol', 'AnchorSymbol'],
        ['AnnotationBoxSymbol', 'AnnotationBoxSymbol'],
        ['AnnotationTextSymbol', 'AnnotationTextSymbol'],
        ['AttitudeSymbol', 'AttitudeSymbol'],
        ['EcosystemSymbol', 'EcosystemSymbol'],
        ['InertiaSymbol', 'InertiaSymbol'],
        ['LinkSymbol', 'LinkSymbol'],
        ['MarketSymbol', 'MarketSymbol'],
        ['MethodSymbol', 'MethodSymbol'],
        ['NoteSymbol', 'NoteSymbol'],
        ['PipelineComponentSymbol', 'PipelineComponentSymbol'],
        ['SubMapSymbol', 'SubMapSymbol'],
    ],
