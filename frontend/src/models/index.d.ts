...
export declare class PublicMap {
  ...
  static copyOf(source: PublicMap, mutator: (draft: MutableModel<PublicMap, PublicMapMetaData>) => MutableModel<PublicMap, PublicMapMetaData> | void): PublicMap;
}
...
export declare class UnauthenticatedMap {
  ...
  static copyOf(source: UnauthenticatedMap, mutator: (draft: MutableModel<UnauthenticatedMap, UnauthenticatedMapMetaData>) => MutableModel<UnauthenticatedMap, UnauthenticatedMapMetaData> | void): UnauthenticatedMap;
}
