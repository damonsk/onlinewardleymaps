describe('Method Duplication Fix Verification', function () {
    test('Components with method decorators should be identifiable', function () {
        ...
        const shouldBeFiltered = !!(component.decorators && component.decorators.method);
        ...
        const shouldNotBeFiltered = !!(regularComponent.decorators && regularComponent.decorators.method);
        ...
        const shouldAlsoNotBeFiltered = !!(componentWithoutDecorators.decorators && componentWithoutDecorators.decorators.method);
    ...
    test('Filter logic works correctly', function () {
        ...
        const filteredComponents = components.filter(c => !(c.decorators && c.decorators.method));
