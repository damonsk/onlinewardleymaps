...
describe('Pipeline Toolbar Integration Tests', () => {
    ...
    describe('Component Addition to Pipeline Workflow', () => {
        ...
        it('should detect when component is within pipeline bounds', () => {
            ...
            const position = { x: 0.50, y: 0.57 }; // Maturity 0.5 is between 0.3 and 0.6
            ...
            expect(validation.nearbyPipeline?.minMaturity).toBe(0.30);
            expect(validation.nearbyPipeline?.maxMaturity).toBe(0.60);
        });
    ...
    describe('Full Pipeline Workflow Simulation', () => {
        it('should simulate complete pipeline creation and component addition workflow', () => {
            ...
            const mockMap: UnifiedWardleyMap = {
                ...
                pipelines: [
                    createPipeline({
                        ...
                        line: 2,
                        components: [
                            { id: 'pc1', name: 'Pipeline Component 1', maturity: 0.30, visibility: 0.60, line: 3 },
                            { id: 'pc2', name: 'Pipeline Component 2', maturity: 0.60, visibility: 0.60, line: 4 },
                        ],
                    }),
                ],
                attitudes: [],
            ...
            const componentPosition = { x: 0.50, y: 0.60 }; // Within pipeline bounds
