    ...
    describe('reference updates', () => {
        it('should update anchor references in links', () => {
            const mapText = [
                ...
                'component ComponentA [0.3, 0.8]',
                'ComponentA->TestAnchor'
            ].join('\n');
            ...
            expect(result.success).toBe(true);
            const expectedText = [
                'anchor NewAnchor [0.5, 0.7]',
                'component ComponentA [0.3, 0.8]',
                'ComponentA->NewAnchor'
            ].join('\n');
        ...
        it('should update quoted anchor references', () => {
            const mapText = [
                'anchor "Test Anchor" [0.5, 0.7]',
                'component ComponentA [0.3, 0.8]',
                'ComponentA->"Test Anchor"'
            ].join('\n');
            ...
            expect(result.success).toBe(true);
            const expectedText = [
                'anchor "New Anchor" [0.5, 0.7]',
                'component ComponentA [0.3, 0.8]',
                'ComponentA->"New Anchor"'
            ].join('\n');
            expect(mutateMapTextSpy).toHaveBeenCalledWith(expectedText);
        });
