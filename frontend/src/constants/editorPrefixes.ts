...
export const EditorPrefixes: string[] = [
    ...
    'component <name> [<visibility>, <maturity>] uncertainty [, +<delta>]',
    'component <name> [<visibility>, <maturity>] uncertainty [-<delta>, ]',
    'component <name> [<visibility>, <maturity>] uncertainty right +<delta>',
    'component <name> [<visibility>, <maturity>] uncertainty left -<delta>',
    ...iterations,
    'anchor',
    'annotation',
    'annotations',
