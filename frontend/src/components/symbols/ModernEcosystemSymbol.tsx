...
/**
 * ModernEcosystemSymbol Props - using unified type system directly
...
/**
 * ModernEcosystemSymbol - Ecosystem symbol representation using unified types
 * This component eliminates legacy type dependencies and improves rendering performance
 */
const ModernEcosystemSymbol: React.FunctionComponent<
    ModernEcosystemSymbolProps
> = ({
    id,
    cx,
    cy,
...
export default memo(ModernEcosystemSymbol);
