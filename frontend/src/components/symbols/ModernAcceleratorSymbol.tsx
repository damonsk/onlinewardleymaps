...
/**
 * ModernAcceleratorSymbol Props - using unified type system directly
...
/**
 * ModernAcceleratorSymbol - Accelerator symbol representation using unified types
 * This component eliminates legacy type dependencies and improves rendering performance
 */
const ModernAcceleratorSymbol: React.FunctionComponent<
...
export default memo(ModernAcceleratorSymbol);
