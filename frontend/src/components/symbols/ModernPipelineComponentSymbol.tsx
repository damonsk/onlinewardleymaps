...
/**
 * ModernPipelineComponentSymbol Props - using unified type system directly
...
/**
 * ModernPipelineComponentSymbol - Pipeline component representation using unified types
 * This component eliminates legacy type dependencies and improves rendering performance
 */
const ModernPipelineComponentSymbol: React.FC<
    ModernPipelineComponentSymbolProps
> = ({
    id,
    x = '-5',
    y = '-5',
...
export default memo(ModernPipelineComponentSymbol);
