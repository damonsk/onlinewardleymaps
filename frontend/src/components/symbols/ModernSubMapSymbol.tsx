...
/**
 * ModernSubMapSymbol Props - using unified type system directly
...
/**
 * ModernSubMapSymbol - SubMap symbol representation using unified types
 * This component eliminates legacy type dependencies and improves rendering performance
 */
const ModernSubMapSymbol: React.FC<ModernSubMapSymbolProps> = ({
    id,
    cx,
    cy,
    onClick,
...
export default memo(ModernSubMapSymbol);
