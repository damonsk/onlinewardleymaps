			...
			this.$rules = {
				start: [
					...
					},
					{
						...
						regex:
							'(pipelinecomponent|evolution|note|anchor|annotations|annotation|component|ecosystem|market|submap|title|style|outsource|build|product|buy|pipeline)(\\s*[-+\'";a-zA-Z0-9\\s*]+)',
					},
					{
						token: [
							'keyword',
