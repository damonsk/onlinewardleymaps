 ...
 */
const PSTResizeExample: React.FC<PSTResizeExampleProps> = ({initialMapText, mapDimensions, mapStyleDefs, scaleFactor = 1}) => {
    ...
    return (
        <div style={{padding: '20px', fontFamily: 'Arial, sans-serif'}}>
            ...
            <div style={{marginBottom: '20px'}}>
                <p>
                    This example demonstrates PST (Pioneers, Settlers, Town Planners) resize functionality. Hover over PST boxes to see
                    resize handles, then drag to resize. The map text is automatically updated when you complete a resize operation.
                </p>
            ...
            <div
                ...
                <svg
                    ...
                    {/* Axis labels */}
                    <text x={mapDimensions.width / 2} y={mapDimensions.height - 10} textAnchor="middle" fontSize="12" fill="#666">
                        Maturity →
                    </text>
                    <text
                        x="15"
