...
/**
 * ModernRelativeMovable - Modern implementation using unified types
 ...
 */
const ModernRelativeMovable: React.FC<ModernRelativeMovableProps> = (props) => {
...
export default ModernRelativeMovable;
