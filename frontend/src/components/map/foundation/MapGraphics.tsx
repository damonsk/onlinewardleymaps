...
const MapGraphics: React.FunctionComponent<MapGraphicsProps> = ({
    mapStyleDefs,
}) => (
    <defs>
        ...
        >
            ...
            <stop
                offset="100%"
                style={{ stopColor: '#8c8995', stopOpacity: 1 }}
            />
        </linearGradient>
        ...
        <marker
            ...
            orient="0"
        >
            <path d="M0,-5L10,0L0,5" fill={mapStyleDefs.link?.evolvedStroke} />
        </marker>

        <marker
            id="graphArrow"
            markerWidth={12 / (mapStyleDefs.strokeWidth ?? 0)}
            markerHeight={12 / (mapStyleDefs.strokeWidth ?? 0)}
            refX="9"
            refY="0"
            viewBox="0 -5 10 10"
            orient="0"
        ...
        <marker
            id="pipelineArrow"
            markerWidth={mapStyleDefs.pipelineArrowWidth}
            markerHeight={mapStyleDefs.pipelineArrowHeight}
            refX="9"
            refY="0"
            viewBox="0 -5 10 10"
            orient="0"
