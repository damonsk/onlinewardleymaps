...
function Usage(props){
    ...
    <p className="small">Usage:<br /><br />
        ...
        <UsageDefinition 
            ...
            summary={"component Name [Visibility (Y Axis), Maturity (X Axis)] evole (X Axis)"}
        ...
        <UsageDefinition 
            ...
            summary={"component Name [Visibility (Y Axis), Maturity (X Axis)] evole (X Axis) inertia"}
...
var UsageDefinition = createReactClass({
    render: function() {
        return (
            ...
            {this.props.summary.length > 0 ? <><br /> {this.props.summary} </>:null}
            <br /><br />
            <strong>Example:</strong><br />
            <UsageExample addOnClick={this.props.addOnClick} example={this.props.example} />
            {this.props.example2.length > 0 ? <><br /><UsageExample addOnClick={this.props.addOnClick} example={this.props.example2} /> </> : null}
            <br /><br />
            ------------------------<br />
            </>
        );
...
var UsageExample = createReactClass({
    render: function() {
        return (
            <a onClick={() => this.props.addOnClick(this.props.example)} href="#" className="add">{this.props.example}</a>
        );
    }
});
