...
function MethodElement(props){
    ...
    const x = () => mapCalc.maturityToX(props.element.maturity, props.mapDimensions.width);
    const y = () => mapCalc.visibilityToY(props.element.visibility, props.mapDimensions.height);

    const defineStoke = function(){
        switch(props.method.method){
            case "outsource": return "#444444";
